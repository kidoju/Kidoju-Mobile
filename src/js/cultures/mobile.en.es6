...
const res = {
    ...
    */
    ...
    appStoreReview: {
        ...
        message:
            'If you enjoy {0}, it won’t take more than a minute to encourage our development effort. Thanks for your help!',
        buttons: {
            cancel: {
    ...
    notifications: {
        ...
        appVersionFailure:
            'You are running an old version which might raise compatibility issues. Please upgrade.',
        batteryCritical: 'Battery level is critical. Recharge now!',
        batteryLow: 'Battery level is low. Recharge soon!',
        clickSubmitInfo:
            'Press <i class="kf kf-submit"></i> to calculate your score.',
        confirmSubmit: 'Do you really want to submit to calculate your score?',
        dbMigrationFailure:
            'The mobile database migration failed during the upgrade.',
        ...
        pageNavigationInfo:
            'Press <i class="kf kf-previous"></i> and <i class="kf kf-next"></i> to navigate pages.',
        ...
        scanFailure:
            'Scan failure. Check the app is authorized to use the camera.',
        ...
        showScoreInfo:
            'Press <i class="kf kf-score"></i> to go back to your score.',
        signinUrlFailure:
            'There was an error obtaining a sign-in url for an authentication provider.',
        summariesQueryFailure:
            'There was an error querying our remote servers.',
        ...
        syncSuccess:
            'Mobile data successfully synchronized with remote servers.',
        syncUnauthorized:
            'You are unauthorised to synchronize. Please signin with an authentication provider.',
        unknownError:
            'There has been an unknown error. Please restart the app.',
    ...
    signin: {
        ...
        // Onboarding
        page0:
            'Browse and search assessments, practice tests and quizzes organized by subject categories.',
        page1:
            'Play questions, give answers and let the app compute your score.',
        page2: 'Track and measure your progresses.',
        // Notification
        welcome:
            'Please select an authentication provider. We shall never use it to post on your behalf.',
        welcome2:
            '{0}, please select the {1} authentication provider to renew your credentials or press <i class="kf kf-user"></i>.'
    },
    // Summary view
    summary: {
        viewTitle: 'Details',
